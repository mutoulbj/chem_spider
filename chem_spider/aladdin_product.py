...
def get_product(key, query):
    detail_urls = db.aladdin_detail_page.find(query)
    collections = {
        'clkx': db.aladdin_product_clkx,
        'fxkx': db.aladdin_product_fxkx,
        'gdhx': db.aladdin_product_gdhx,
        'smkx': db.aladdin_product_smkx
    }
    product_count = collections[key].count()
